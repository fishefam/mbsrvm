 ...
 */
export function configureProfile(profile, { app = 'firefox', customPrefs = {}, getPrefs = defaultPrefGetter } = {}) {
...
export function defaultCreateProfileFinder({ FxProfile = FirefoxProfile, userDirectoryPath } = {}) {
 ...
 */
export async function createProfile({ app, configureThisProfile = configureProfile, customPrefs = {} } = {}) {
  const profile = new FirefoxProfile()
  return await configureThisProfile(profile, {
    app,
    customPrefs,
